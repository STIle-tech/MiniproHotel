...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Room',
            fields=[
                ('roomname', models.CharField(default='', max_length=50)),
                ('room_number', models.CharField(default='', max_length=13, primary_key=True, serialize=False)),
                ('price', models.FloatField(default=0.0)),
                ('address', models.CharField(default='', max_length=200)),
                ('roomsize', models.CharField(default='', max_length=50)),
                ('view', models.CharField(default='', max_length=50)),
                ('bed', models.CharField(default='', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='RoomCategory',
            fields=[
                ('rid', models.CharField(default='', max_length=13, primary_key=True, serialize=False)),
